            ...
            <div class="masthead">
               ...
               <ul class="nav">
                  ...
                  <li class="link"><a class="main"  href="">Source Files</a>
                     <ul class="sub">
                        <li><a href="./Doane-Journal.xml">TEI: Source Markup</a></li>
...
-->
   ...
   <xsl:template match="tei:choice/tei:sic[ not(.='Captian' or .='Captians' or .='sot' or .='Colars' or .='colars' or .='Shoot' or .='Westard' or .='westard' or .='Tusday')]">
