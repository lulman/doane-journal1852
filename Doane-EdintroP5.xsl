               ...
               <div id="navigation">
                  <ul class="nav">
                     <li class="link"><a class="main"  href="./sscox_journal.html#introduction">Historical Introduction</a>
                        <ul class="sub">
                           <li><a href="./doane_journal.html#crossing">Crossing the Atlantic</a></li>
                           <li><a href="./doane_journal.html#liverpool">Liverpool</a></li>
                           <li><a href="./doane_journal.html#london">London</a></li>
                           <li><a href="./doane_journal.html#paris">Paris and Southern France</a></li>
                           <li><a href="./doane_journal.html#sardinia">Sardinia and Tuscany</a></li>
                           <li><a href="./doane_journal.html#rome">"Eternal Rome"</a></li>
                           <li><a href="./doane_journal.html#orient">The "Dreamy Orient"</a></li>
                           <li><a href="./doane_journal.html#trieste">Trieste</a></li>
                        </ul>
                     </li>
                     ...
                     <li class="link"><a class="main"  href="">Views of the Diary</a>
                        <ul class="sub">
                           <li><a href="./doane_journal-by-entry.html">By Diary Entry</a></li>
                           <li><a href="./doane_journal-by-ms-page.html">By MS Page</a></li>
                           <li><a href="./doane_journal-combined.html">Facsimile/Text</a></li>
                        </ul>
                     </li>
                     ...
                     <li class="link"><a class="main"  href="">Source Files</a>
                        <ul class="sub">
                           ...
                           <li><a href="./doane_Common.xsl">XSL: Base Stylesheet</a></li>
                           <li><a href="./doane_Diplomatic.xsl">XSL: MS Page View</a></li>
                           <li><a href="./doane_Reading.xsl">XSL: Entry View</a></li>
                           <li><a href="./doane_CombinedView.xsl">XSL: Text/Facs View</a></li>
                           <li><a href="./doane_Edintro.xsl">XSL: Ed. Intro</a></li>
                           <li><a href="./doane_journal.css">CSS: Style Sheet</a></li>
                           <li><a href="./doane_Current.odd.txt">ODD: TEI Customization</a></li>
                           <li><a href="./doane_Current.rng.txt">RNG: Schema</a></li>
                        </ul>
                     </li>
                  </ul> <!-- End ul class nav -->
