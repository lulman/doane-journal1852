            ...
            <p align="center">
               <a href="http://people.cohums.ohio-state.edu/ulman1/LADoaneJournal/default.cfm" target="self"
                  ...
                  target="self"> Diplomatic</a> | MS Image / Text (current/<a
                     href="http://suse1.cohums.ohio-state.edu/tomcat/cocoon/eng569/Doane-Journal.Doane-SplitviewP5#view"
                  target="self">about</a>)
      ...
      <span class="pagebreak"> [Page&#xA0;-&#xA0;<xsl:number count="tei:pb" format="1"
         level="any"/>&#xA0; (<a><xsl:attribute name="HREF"
            >http://people.cohums.ohio-state.edu/ulman1/LADoaneJournal/DoaneZoom.cfm?file=<xsl:value-of
               select="@facs"/>.jpg</xsl:attribute><xsl:attribute name="target"
